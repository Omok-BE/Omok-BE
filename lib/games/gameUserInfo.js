  ...
  return await Games.aggregate([
     ...
     },
     {
       $project: {
         ...
         blackTeamObserver: { id: 1, score: 1, point: 1, state: 1, teachingCnt:1, profileImage:1, connect:1 },
         whiteTeamPlayer: { id: 1, score: 1, point: 1, state: 1, profileImage:1 },
         whiteTeamObserver: { id: 1, score: 1, point: 1, state: 1, teachingCnt:1, profileImage:1, connect:1 },
         timer: 1
       },
     },
  ]);
